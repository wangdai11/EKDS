...
xlswrite('eemd_ASD.xlsx',rlt1);
xlswrite('eemd_MFDFA.xlsx',THq1a,param(1,1:2));
xlswrite('eemd_MFDFA.xlsx',Ttq1a,param(2,1:2));
xlswrite('eemd_MFDFA.xlsx',Th1a,param(3,1:2));
xlswrite('eemd_MFDFA.xlsx',TDq1a,param(4,1:2));
xlswrite('eemd_TD.xlsx',feature);
