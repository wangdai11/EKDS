...
xlswrite('vmd_ASD.xlsx',rlt1);
xlswrite('vmd_MFDFA.xlsx',THq1a,param(1,1:2));
xlswrite('vmd_MFDFA.xlsx',Ttq1a,param(2,1:2));
xlswrite('vmd_MFDFA.xlsx',Th1a,param(3,1:2));
xlswrite('vmd_MFDFA.xlsx',TDq1a,param(4,1:2));
xlswrite('vmd_TD.xlsx',feature);
